    ...
    <div>
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ color: 'var(--color-text-secondary)', fontSize: 14, margin: 0 }}>
          Chronological investigation events • Evidence provenance tracking
        </p>
      </div>
      ...
      <div className="monara-card" style={{ 
        ...
        <p style={{ fontSize: 14, color: 'var(--color-text-secondary)', marginBottom: 24, maxWidth: 400, margin: '0 auto 24px' }}>
          Access the investigation timeline from within a case to view chronological events and evidence collection history.
        </p>
        <div style={{ fontSize: 12, color: 'var(--color-text-tertiary)' }}>
          Navigate to a case → Open Timeline tab
        </div>
      </div>
